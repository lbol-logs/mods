...
namespace lvalonexrumia.Config
{
	public sealed class lvalonexrumiaDefaultConfig
	{
		...
		public static CardConfig CardDefaultConfig()
		{
			...
			return new CardConfig(num, text, num2, flag, array, text2, text3, num3, flag2, flag3, flag4, flag5, flag6, rarity, cardType, targetType, readOnlyList, flag7, manaGroup, manaGroup2, null, null, num4, num5, num6, num7, num8, num9, num10, num11, num12, num13, num14, manaGroup3, manaGroup4, null, null, null, null, null, null, null, null, null, null, null, null, null, Keyword.None, Keyword.None, false, Keyword.None, Keyword.None, new List<string>(), new List<string>(), new List<string>(), new List<string>(), lvalonexrumiaDefaultConfig.OwnerName, "", "", false, null, new List<string>());
		}

		public static ExhibitConfig DefaultExhibitConfig()
		{
			return new ExhibitConfig(0, "", 10, false, false, false, false, AppearanceType.Nowhere, lvalonexrumiaDefaultConfig.OwnerName, ExhibitLosableType.DebutLosable, Rarity.Shining, null, null, null, new ManaGroup?(default(ManaGroup)), null, new ManaColor?(ManaColor.White), 1, false, null, Keyword.None, new List<string>(), new List<string>());
		}
