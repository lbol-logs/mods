...
namespace Momiji.Source.ImageLoader
{
	public sealed class SampleCharacterDefaultConfig
	{
		...
		{
			return new CardConfig(0, "", 10, true, new string[0][], "", "", 0, false, true, true, false, true, Rarity.Common, CardType.Unknown, null, new List<ManaColor>(), false, default(ManaGroup), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, Keyword.None, Keyword.None, false, Keyword.None, Keyword.None, new List<string>(), new List<string>(), new List<string>(), new List<string>(), SampleCharacterDefaultConfig.OwnerName, "", "", false, null, new List<string>());
		}
