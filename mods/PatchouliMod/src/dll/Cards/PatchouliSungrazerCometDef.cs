...
{
	public sealed class PatchouliSungrazerCometDef : PatchouliCardTemplate
	{
		public override CardConfig MakeConfig()
		{
			CardConfig cardDefaultConfig = base.GetCardDefaultConfig();
			cardDefaultConfig.Index = 5620;
			...
			cardDefaultConfig.Illustrator = PatchouliIllustrator.PatchouliSungrazerComet;
