...
namespace PatchouliCharacterMod.ImageLoader
{
	public sealed class PatchouliDefaultConfig
	{
		...
		{
			return new ExhibitConfig(0, "", 10, false, false, false, false, AppearanceType.Nowhere, PatchouliDefaultConfig.OwnerName, ExhibitLosableType.DebutLosable, Rarity.Shining, null, null, null, new ManaGroup?(default(ManaGroup)), null, new ManaColor?(ManaColor.White), 1, false, null, Keyword.None, new List<string>(), new List<string>());
		}
