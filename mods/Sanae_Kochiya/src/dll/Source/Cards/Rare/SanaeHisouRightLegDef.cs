...
{
	public sealed class SanaeHisouRightLegDef : SampleCharacterCardTemplate
	{
		public override CardConfig MakeConfig()
		{
			...
			cardDefaultConfig.RelativeKeyword = Keyword.Overdraft;
			cardDefaultConfig.UpgradedRelativeKeyword = Keyword.Overdraft;
