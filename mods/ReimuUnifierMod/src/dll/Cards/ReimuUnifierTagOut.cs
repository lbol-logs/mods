...
{
	[EntityLogic(typeof(ReimuUnifierTagOutDef))]
	public sealed class ReimuUnifierTagOut : ReimuUnifierCard
	{
		...
		{
			ReimuUnifierTagOut.<Actions>d__1 <Actions>d__ = new ReimuUnifierTagOut.<Actions>d__1(-2);
