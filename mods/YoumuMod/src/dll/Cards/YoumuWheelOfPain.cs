...
{
	[EntityLogic(typeof(YoumuWheelOfPainDef))]
	public sealed class YoumuWheelOfPain : YoumuCard
	{
		protected override IEnumerable<BattleAction> Actions(UnitSelector selector, ManaGroup consumingMana, Interaction precondition)
		{
			...
			if (flag)
			{
				yield return base.BuffAction<YoumuWheelOfPainSe>(base.Value1, 0, 0, 0, 0.2f);
			}
			yield break;
			yield break;
		}
