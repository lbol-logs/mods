...
{
	public sealed class YoumuInsightfulSwordDef : YoumuCardTemplate
	{
		public override CardConfig MakeConfig()
		{
			CardConfig cardDefaultConfig = base.GetCardDefaultConfig();
			cardDefaultConfig.Index = 3005;
			cardDefaultConfig.GunName = YoumuGunName.InsightfulSword;
			...
			cardDefaultConfig.Illustrator = YoumuIllustrator.InsightfulSword;
